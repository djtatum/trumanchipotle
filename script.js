...
// --- Form Submission & Typewriter Effect ---
...
form.addEventListener('submit', (e) => {
    ...
    feedback.textContent = "Tuning receiver...";
    
    setTimeout(() => {
        feedback.textContent = "";
        feedback.style.opacity = '1';
        
        const message = "Transmission locked. You will hear from us in the quiet.";
        let index = 0;
        
        function type() {
            if (index < message.length) {
                feedback.textContent += message.charAt(index);
                index++;
                setTimeout(type, 30);
            }
        }
